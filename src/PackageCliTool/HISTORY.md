...
scriptModel:
  # Complete configuration used to generate the script
  templateName: "Umbraco.Templates"
  templateVersion: "14.3.0"
  projectName: "MyBlog"
  packages: "uSync|17.0.0,Umbraco.Forms|14.2.0"
  # ... all other settings
templateName: "my-blog"  # If generated from a template
wasExecuted: true
executionDirectory: "/home/user/projects/myblog"
exitCode: 0
description: "Blog setup for client"
tags:
  - blog
  - client-project
```
...
~/.psw/
├── history/
│   └── history.yaml    # All history entries
├── templates/
└── config.json
```
