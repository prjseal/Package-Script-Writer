...
- id: 8a3f5c21-9d42-4e7b-b1a3-c8e6f4d2a9b7
  ...
  scriptContent: |
    # Umbraco Project Setup Script
    # Generated by Package Script Writer
    # Project: MyBlog
    # Template: Umbraco.Templates

    dotnet new install Umbraco.Templates
    dotnet new umbraco -n "MyBlog"
    cd MyBlog
    dotnet add package uSync --version 13.2.1
    dotnet add package Umbraco.Community.BlockPreview --version 13.0.0
...
| `scriptContent` | string | Full generated script |
...
| **Contains Script** | ✅ Yes - full script content saved | ❌ No - regenerates on load |
